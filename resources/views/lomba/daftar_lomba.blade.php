...
<div class="container-fluid">
    <nav class="navbar navbar-dark" , style="background-color: #242526" ;>
        <div class="container-fluid ms-auto">
            <a class="navbar-brand"><span>Cari</span>Lomba</a>
            <form class="d-flex">
                <input
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        Perlombaan {{$lomba->tingkat}} | Deadline Pendaftaran : {{$lomba->deadline_pendaftaran}}
                                    </p>
        ...
        <div class="button-add">
            <div class="d-grid mt-5 mb-5">
                <button class="button-add" type="button">
                    <a href="{{route('add_lomba')}}">Tambah Lomba</a>
                </button>
            </div>
        </div>
